...
* The **mean** total number of steps taken per day is `r format(meantotal, scientific = FALSE)` steps.
* The **median** total number of steps taken per day is `r format(mediantotal, scientific = FALSE)` steps.
...
On average it's `r maxStepsInterval` interval that contains the maximum number of steps across all the days in the dataset.
